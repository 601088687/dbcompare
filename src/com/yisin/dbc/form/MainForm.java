                            ...
                            for (int j = 0; j < columnList2.size(); j++) {
                                ...
                                if (com1.getColumnName().equalsIgnoreCase(com2.getColumnName())) {
                                    ...
                                    if (com1.getColumnType().equalsIgnoreCase(com2.getColumnType())
                                            ...
                                            && CommonUtils.excNullToString(com1.getCharacterSetName(), "").equalsIgnoreCase(CommonUtils.excNullToString(com2.getCharacterSetName(), ""))
                                            && CommonUtils.excNullToString(com1.getCollationName(), "").equalsIgnoreCase(CommonUtils.excNullToString(com2.getCollationName(), ""))) {
