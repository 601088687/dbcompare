        ...
        for (Map.Entry<String, List<DbTableColumn[]>> listEntry : sameMap.entrySet()) {
            ...
            if (coluList.size() > 0) {
                ...
                for (int i = 0, k = coluList.size(); i < k; i++) {
                    ...
                    trtd2 = Utililies.parseTemplate(trtd2, "characterSetName1", colum1 != null ? colum1.getCharacterSetName() : "--");
                    trtd2 = Utililies.parseTemplate(trtd2, "collationName1", colum1 != null ? colum1.getCollationName() : "--");
                    ...
                    trtd2 = Utililies.parseTemplate(trtd2, "characterSetName2", colum2 != null ? colum2.getCharacterSetName() : "--");
                    trtd2 = Utililies.parseTemplate(trtd2, "collationName2", colum2 != null ? colum2.getCollationName() : "--");
                    ...
                    // 8、字符集类型
                    if (colum1 != null && colum2 != null) {
                        if (colum1.getCharacterSetName() == null && colum2.getCharacterSetName() == null) {
                            trtd2 = Utililies.parseTemplate(trtd2, "same8", "");
                        } else if (colum1.getCharacterSetName() != null && colum2.getCharacterSetName() != null
                                && colum1.getCharacterSetName().equalsIgnoreCase(colum2.getCharacterSetName())) {
                            trtd2 = Utililies.parseTemplate(trtd2, "same8", "");
                        } else {
                            trtd2 = Utililies.parseTemplate(trtd2, "same8", "same");
                        }
                    } else {
                        trtd2 = Utililies.parseTemplate(trtd2, "same8", "same");
                    }
                    ...
                    // 9、排序规则
                    if (colum1 != null && colum2 != null) {
                        if (colum1.getCollationName() == null && colum2.getCollationName() == null) {
                            trtd2 = Utililies.parseTemplate(trtd2, "same9", "");
                        } else if (colum1.getCollationName() != null && colum2.getCollationName() != null
                                && colum1.getCollationName().equalsIgnoreCase(colum2.getCollationName())) {
                            trtd2 = Utililies.parseTemplate(trtd2, "same9", "");
                        } else {
                            trtd2 = Utililies.parseTemplate(trtd2, "same9", "same");
                        }
                    } else {
                        trtd2 = Utililies.parseTemplate(trtd2, "same9", "same");
                    }
